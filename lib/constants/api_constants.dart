class ApiConstants {
  ...
  static String baseUrl = 'http://192.168.18.188:8000';
  ...
  static String downloadDocumentUrl(int id) => '$baseUrl/api/documents/$id/download';
  static String updateProgressUrl(int id) => '$baseUrl/api/documents/$id/progress';
  static String updateTotalPagesUrl(int id) => '$baseUrl/api/documents/$id/total-pages';
  static String deleteDocumentUrl(int id) => '$baseUrl/api/documents/$id';
  static String get bulkDeleteDocumentsUrl => '$baseUrl/api/documents/bulk-delete';
  
  static String getHighlightsUrl(int docId) => '$baseUrl/api/documents/$docId/highlights';
